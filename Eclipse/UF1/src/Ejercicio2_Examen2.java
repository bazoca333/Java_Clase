...
public static void main(String[] args) {
	...
	while (fin == false) {
		...
		//Rellenar la matriz con números aleatorios entre 0 y 50 y mostrar la matriz por pantalla
		...
		if (eleccion.equals("A")) {
			...
			//Forzar y determinar si todas las posiciones de la matriz donde el índice i (número de 
			...
			//Ahora, forzar y determinar si todas las posiciones de la matriz donde el índice i
			//(número de fila) es mayor al índice j (número de la columna) tienen un valor de 0.
